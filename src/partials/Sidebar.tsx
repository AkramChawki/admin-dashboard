import { Billingicon, Gridicon, Homeicon, Projecticon, Settingicon, Statsicon, Usericon } from "../components/icons";
...
function MenuItem({ title, icon, active = false }: MenuItemProps) {
    const styles = "flex space-x-4 px-6 py-3 cursor-pointer text-black hover:bg-gray-100 transition-all"
...
function Avatar() {
    return (
        <div className="border-2 border-gray-200 p-1.5 rounded-2xl w-16 h-16 relative">
            <img className="w-full h-full rounded-2xl" src="https://i.pravatar.cc/150?img=3" alt="" />
            <div className="absolute right-0 bottom-0 w-3 h-3 bg-green-500 rounded-full border-2 border-white -translate-x-1/2 -translate-y-1/2">
    ...
    return (
      <div className='w-[250px] h-full flex flex-col border-r-2 border-r-gray-200 py-4'>
        ...
        <Menu>
            ...
            <MenuItem title="Projects" icon={<Projecticon />} />
