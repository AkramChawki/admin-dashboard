...
import { Billingicon, Homeicon, Projecticon, Settingicon, Statsicon, Usericon } from './icons'
import chart from '../img/bg.png'
...
function Statistics() {
    return (
        <div className='col-span-3 bg-black rounded-3xl flex flex-col py-6'>
            ...
            <img src={chart} className="w-full -h-full my-4" alt="" />
        </div>
    )
}
